...
describe ProjectHookParser do
  describe "Parser should transform hook to have the appropriate params" do
    ...
    it "#to_param!" do
      ...
      expected_hash = {:name=>"StoreCloud", :id=>74, :path=>"stormcloud", :path_namespace=>"jsmith/stormcloud",
                           :ssh_url_to_repo=>"http://localhost/git/user/project.git", :http_url_to_repo=>"git@localhost:user/project.git"}
